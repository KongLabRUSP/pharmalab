...
f1 <- "D:/Yue_MethylSeq_Processed_03202017/Results/results_yue_old_2.ctrl_vs_2.aom.dss_all.p_mindiff.0.1.csv"
...
f2 <- "D:/Yue_MethylSeq_Processed_03202017/Results/results_yue_old_2.aom.dss_vs_2.aom.dss.curc_all.p_mindiff.0.1.csv"
...
tiff(filename = "tmp/venn_yue_old_up_down_chipseeker_cpg5over.tiff",
     height = 5,
     width = 10,
     units = 'in',
     res = 300,
...
p1 <- venn.diagram(x = list(A = which(xx %in% l1),
                   ...
                   alpha = c(0.5, 0.5),
                   compression = "lzw+p",
                   main = "Yue's Old Samples, Two Per Treatment, CpG > 4",
...
tiff(filename = "tmp/venn_yue_old_down_up_chipseeker_cpg5over.tiff",
     height = 5,
     width = 10,
     units = 'in',
     res = 300,
...
# Save----
write.csv(dt1, 
          file = "tmp/negctr_aomdss_old.csv",
          row.names = FALSE)
write.csv(dt2, 
          file = "tmp/aomdss_aomdsscur_old.csv",
          row.names = FALSE)
out <- list(negctr_aomdss = dt1,
            aomdss_aomdsscur = dt2)
save(out,
