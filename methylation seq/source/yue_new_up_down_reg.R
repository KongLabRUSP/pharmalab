...
dt1 <- fread("D:/Yue_MethylSeq_Processed_03202017/Results/results_yue_new_2.ctrl_vs_2.aom.dss_all.p_mindiff.0.1.csv")
...
dt2 <- fread("D:/Yue_MethylSeq_Processed_03202017/Results/results_yue_new_2.aom.dss_vs_2.aom.dss.curc_all.p_mindiff.0.1.csv")
...
tiff(filename = "tmp/venn_yue_new_up_down.tiff",
     height = 4,
     width = 4,
     units = 'in',
     res = 300,
...
tiff(filename = "tmp/venn_new_down_up.tiff",
     height = 4,
     width = 4,
     units = 'in',
     res = 300,
