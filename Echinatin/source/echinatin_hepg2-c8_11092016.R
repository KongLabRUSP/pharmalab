...
# Data----
# 1. BCA----
bca <- fread("Echinatin/data/HepG2C8_SFN_Ech_BCA_11092016.csv",
             sep = ",",
             header = TRUE)

# BCA Maps----
bca.map <- fread("Echinatin/data/Map_HepG2C8_SFN_Ech_BCA_11092016.csv",
                 sep = ",",
                 header = TRUE)

# 2. Luciferase----
luc <- fread("Echinatin/data/HepG2C8_SFN_Ech_Luciferace_11092016.csv",
             sep = ",",
             header = TRUE)
