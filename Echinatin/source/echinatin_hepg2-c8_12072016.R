...
# Data----
# 1. BCA----
bca <- fread("Echinatin/data/HepG2C8_SFN_Ech_BCA_12072016.csv",
             sep = ",",
             header = TRUE)
...
# 2. Luciferase----
luc <- fread("Echinatin/data/HepG2C8_SFN_Ech_Luciferace_12072016.csv",
             sep = ",",
             header = TRUE)
...
# ATTENTION! REMOVE OUTLIER IN 12/07/2016 EXPERIMENT
alb$BCA[22] <- NA
